...
- **Testo manuale**: menu contestuale **Testo → Inserisci manualmente…** per scrivere o incollare quando la ricerca automatica non trova nulla
- Colonna **Testo** (Sì/No) nella tabella brani
